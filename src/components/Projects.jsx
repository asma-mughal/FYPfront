            ...
            <div className=''>
                ...
                border border-gray-400 mb-6">
                    ...
                    <div className='px-3 py-3'>
                        ...
                        dark:text-gray-100 font-bold text-lg mb-0.5 font-poppins">{item.name}</h2>
          ...
          <img
            ...
            <div class="
              ...
              <div class="m-10">
                ...
                <div class="text-secondary font-bold text-xl uppercase  mb-2">{i.name}</div>
                <div class="text-gray-900 font-bold text-base   mb-2">Campaign By: {i.campaignBy}</div>
                <div class="text-gray-900 font-normal text-base   mb-2">lorem ispum
                lorem ispum
                lorem ispum
                lorem ispum
                </div>
                <div class="flex flex-row ">
  <div className='pr-24'><text className={`${styles.paragraphDark} max-w-[470px]`}>Raised: {i.Raised} ETH</text></div>
  <div className={`${styles.paragraphDark} max-w-[470px] px-1.5`}>Goal {i.Goal} ETH</div>
</div>
                <div class="w-full bg-gray-200 rounded-full dark:bg-gray-700 mb-5">
    <div class="bg-secondary text-xs font-medium text-blue-100 text-center p-0.5 
    leading-none rounded-full" style={{
